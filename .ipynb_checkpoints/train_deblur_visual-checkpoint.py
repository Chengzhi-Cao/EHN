...
def main():
    ...
    parser.add_argument('-opt', type=str,default='options/train_derain/STRANH_exam_derain.yml', help='Path to option YAML file.')
    parser.add_argument('-save_dir', type=str,default='/output/Result2', help='Path to option YAML file.')
