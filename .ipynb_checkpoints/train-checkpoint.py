...
def main():
    ...
    parser.add_argument('-opt', type=str,default='options/train_lol_deblur/D2HNet.yml', help='Path to option YAML file.')
    parser.add_argument('-save_dir', type=str,default='/gdata1/caocz/Event_Camera/IJCV/Result2', help='Path to option YAML file.')
            ...
            if opt['datasets'].get('val', None) and current_step % opt['train']['val_freq'] == 0:
                if opt['model'] in ['sr', 'srgan'] and rank <= 0:  # image restoration validation
                    ...
                    for val_data in val_loader:
                        ...
                        avg_lpips += util.calculate_lpips(sr_img,gt_img)
