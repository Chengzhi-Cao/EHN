...
def main():
    ...
    parser.add_argument('-opt', type=str,default='options/train_real_rain/DCSFN_exam.yml', help='Path to option YAML file.')
    parser.add_argument('-save_dir', type=str,default='/data/chengzhicao/NTURain/NTURain/result_real_rain/DCSFN_exam', help='Path to option YAML file.')
