...
#         self.print_network()
    ...
    def optimize_parameters(self, step):
        ...
        event_array = self.event_array  # 2通道 event_array=[2,3,128,128] 
        #######################################################
        #######################################################
        #######################################################   
        LR_img_event = torch.cat([LR_input,event_array],axis=1)
        # [2,45,128,128]
        # self.fake_H = self.netG(LR_img_event)
    ...
    def test(self):
        ...
        event_array = event_array[:,:,:,0:LR_input.shape[-1]]
