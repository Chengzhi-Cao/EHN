...
def main():
    ...
    parser.add_argument('-opt', type=str,default='options/train_derain/DCSFN_exam.yml', help='Path to option YAML file.')
    parser.add_argument('-save_dir', type=str,default='/data/chengzhicao/NTURain/NTURain/Result2/DCSFN', help='Path to option YAML file.')
